...
print('On your next birthday, you will be', int(age) + int(1))
print()
eggs = input('How many egg cartoons do you have? ')
print('You have', int(eggs) * int(12), 'eggs')
print()
cookies = input('How many cookies do you have? ')
people = input('How many are there? ')
print('Each person may have', int(cookies) / int(people), 'cookies')
